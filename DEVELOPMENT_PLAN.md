...
- [ ] 1.1.1: Set up SQLite with rusqlite
- [ ] 1.1.2: Integrate sqlite-vec extension
- [ ] 1.1.3: Implement schema migrations
- [ ] 1.2.1: Define storage traits and models
- [ ] 1.2.2: Implement chunk storage operations
